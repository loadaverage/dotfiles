...
hi MatchParen ctermfg=180 ctermbg=NONE cterm=bold guifg=#dda790 guibg=#576EFF gui=bold
...
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=#FF7200 guibg=NONE gui=underline
