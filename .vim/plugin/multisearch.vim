...
let s:highlight = {
  ...
  \     'args': [
  \       '',
  \       'guibg=yellow guifg=black ctermbg=yellow term=bold',
  \       'guibg=lightred guifg=white ctermbg=lightred term=bold',
  ...
  \       'guibg=darkyellow guifg=white term=bold',
  \       'guibg=gray guifg=white term=bold',
  \       'guibg=magenta guifg=white ctermbg=magenta term=bold',
  \       'guibg=orange guifg=white term=bold',
